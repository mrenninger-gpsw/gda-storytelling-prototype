package project.views.SettingsOverlay{
	...
	public class LabelledCheckbox extends Sprite{
		...
		/******************** CONSTRUCTOR *********************/
		public function LabelledCheckbox($id:String, $labelText:String, $multiline:Boolean = false){
			super();
			verbose = true;
		...
		private function _draw():void{
			...
			_tf = TextUtilities.dynamicTextField({textFormat: _fmt, autoSize:'left', wordWrap:false, multiline:_multiline, embedFonts:true});
